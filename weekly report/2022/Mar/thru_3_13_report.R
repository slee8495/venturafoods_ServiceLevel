...
thru_3_6 %>% 
  dplyr::filter(Ship_Year_Month != "2022 - (03) Mar") -> thru_3_6


# Read data

thru_3_13 <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Report/Root Cause Report/2022/Mar/3.13.2022/thru_3_13.xlsx", 
...
colnames(thru_3_13)[1] <- "Super_Customer_Number"
colnames(thru_3_13)[2] <- "Super_Customer_Name"
colnames(thru_3_13)[3] <- "Mfg_Location"
colnames(thru_3_13)[4] <- "Mfg_Location_Name"
colnames(thru_3_13)[5] <- "Ship_Location"
colnames(thru_3_13)[6] <- "Ship_Location_Name"
colnames(thru_3_13)[7] <- "Product_Label"
colnames(thru_3_13)[8] <- "Product_Label_Name"
colnames(thru_3_13)[9] <- "ProductPlatformDesc"
colnames(thru_3_13)[10] <- "Line_Number"
colnames(thru_3_13)[11] <- "Line_Description"
colnames(thru_3_13)[12] <- "AS_Variable_Margine_Per_Pound"
colnames(thru_3_13)[13] <- "Pack_Size_Name"
colnames(thru_3_13)[14] <- "Product_Category_Name_105"
colnames(thru_3_13)[15] <- "Base_Product"
colnames(thru_3_13)[16] <- "Base_Product_Name_10206"
colnames(thru_3_13)[17] <- "Product_SKU"
colnames(thru_3_13)[18] <- "Product_SKU_Name_10206_GNS"
colnames(thru_3_13)[19] <- "AS_Cases"
colnames(thru_3_13)[20] <- "AS_Order_Quantity"
colnames(thru_3_13)[21] <- "AS_Original_Order_Quantity"
colnames(thru_3_13)[22] <- "AS_Net_Pounds"
colnames(thru_3_13)[23] <- "AS_Variable_Margin"
colnames(thru_3_13)[24] <- "Pack_Size"
colnames(thru_3_13)[25] <- "Shipped_Date"
colnames(thru_3_13)[26] <- "Shipped_Year"
colnames(thru_3_13)[27] <- "Shipped_Month"
colnames(thru_3_13)[28] <- "Short_Ship_Reason"
colnames(thru_3_13)[29] <- "Geo_Location"
colnames(thru_3_13)[30] <- "Channel"
colnames(thru_3_13)[31] <- "Customer"
colnames(thru_3_13)[32] <- "MFG_Site"
colnames(thru_3_13)[33] <- "Shipping_Main"
colnames(thru_3_13)[34] <- "Shipping_Location"
colnames(thru_3_13)[35] <- "Site_Line"
colnames(thru_3_13)[36] <- "Item"
colnames(thru_3_13)[37] <- "Ship_Month"
colnames(thru_3_13)[38] <- "Ship_Year_Month"
colnames(thru_3_13)[39] <- "Sysco_BAPA_SKU"
colnames(thru_3_13)[40] <- "Label_w_Desc"
colnames(thru_3_13)[41] <- "Product_SKU_w_Description"
colnames(thru_3_13)[42] <- "COVID_PRIORITY_SKU"
colnames(thru_3_13)[43] <- "PRIORITY_SKU"
colnames(thru_3_13)[44] <- "MTO_SOP"
colnames(thru_3_13)[45] <- "Macro_Platform"
colnames(thru_3_13)[46] <- "Starch_Supply_Impacted"
colnames(thru_3_13)[47] <- "Starch_Impacted"
...
thru_3_13 %>% 
  ...
  dplyr::mutate(Case_Cut_Original_Order_Qty = AS_Original_Order_Quantity - AS_Cases) -> thru_3_13
...
thru_3_13 %>% 
  ...
  dplyr::mutate(Original_Case_Fill = AS_Cases / AS_Original_Order_Quantity) -> thru_3_13


# Important index !!! ----

rbind(thru_3_6, thru_3_13) -> thru_3_13
...
thru_3_13$AS_Variable_Margine_Per_Pound[is.na(thru_3_13$AS_Variable_Margine_Per_Pound)] <- 0
thru_3_13$AS_Cases[is.na(thru_3_13$AS_Cases)] <- 0
thru_3_13$AS_Order_Quantity[is.na(thru_3_13$AS_Order_Quantity)] <- 0
thru_3_13$AS_Original_Order_Quantity[is.na(thru_3_13$AS_Original_Order_Quantity)] <- 0
thru_3_13$AS_Net_Pounds[is.na(thru_3_13$AS_Net_Pounds)] <- 0
thru_3_13$AS_Variable_Margin[is.na(thru_3_13$AS_Variable_Margin)] <- 0


save(thru_3_13, file = "thru_3_13.RData")
