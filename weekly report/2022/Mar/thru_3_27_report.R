...
thru_3_20 %>% 
  dplyr::filter(Ship_Year_Month != "2022 - (03) Mar") -> thru_3_20


# Read data

thru_3_27 <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Report/Root Cause Report/2022/Mar/3.27.2022/thru_3_27.xlsx", 
...
colnames(thru_3_27)[1] <- "Super_Customer_Number"
colnames(thru_3_27)[2] <- "Super_Customer_Name"
colnames(thru_3_27)[3] <- "Mfg_Location"
colnames(thru_3_27)[4] <- "Mfg_Location_Name"
colnames(thru_3_27)[5] <- "Ship_Location"
colnames(thru_3_27)[6] <- "Ship_Location_Name"
colnames(thru_3_27)[7] <- "Product_Label"
colnames(thru_3_27)[8] <- "Product_Label_Name"
colnames(thru_3_27)[9] <- "ProductPlatformDesc"
colnames(thru_3_27)[10] <- "Line_Number"
colnames(thru_3_27)[11] <- "Line_Description"
colnames(thru_3_27)[12] <- "AS_Variable_Margine_Per_Pound"
colnames(thru_3_27)[13] <- "Pack_Size_Name"
colnames(thru_3_27)[14] <- "Product_Category_Name_105"
colnames(thru_3_27)[15] <- "Base_Product"
colnames(thru_3_27)[16] <- "Base_Product_Name_10206"
colnames(thru_3_27)[17] <- "Product_SKU"
colnames(thru_3_27)[18] <- "Product_SKU_Name_10206_GNS"
colnames(thru_3_27)[19] <- "AS_Cases"
colnames(thru_3_27)[20] <- "AS_Order_Quantity"
colnames(thru_3_27)[21] <- "AS_Original_Order_Quantity"
colnames(thru_3_27)[22] <- "AS_Net_Pounds"
colnames(thru_3_27)[23] <- "AS_Variable_Margin"
colnames(thru_3_27)[24] <- "Pack_Size"
colnames(thru_3_27)[25] <- "Shipped_Date"
colnames(thru_3_27)[26] <- "Shipped_Year"
colnames(thru_3_27)[27] <- "Shipped_Month"
colnames(thru_3_27)[28] <- "Short_Ship_Reason"
colnames(thru_3_27)[29] <- "Geo_Location"
colnames(thru_3_27)[30] <- "Channel"
colnames(thru_3_27)[31] <- "Customer"
colnames(thru_3_27)[32] <- "MFG_Site"
colnames(thru_3_27)[33] <- "Shipping_Main"
colnames(thru_3_27)[34] <- "Shipping_Location"
colnames(thru_3_27)[35] <- "Site_Line"
colnames(thru_3_27)[36] <- "Item"
colnames(thru_3_27)[37] <- "Ship_Month"
colnames(thru_3_27)[38] <- "Ship_Year_Month"
colnames(thru_3_27)[39] <- "Sysco_BAPA_SKU"
colnames(thru_3_27)[40] <- "Label_w_Desc"
colnames(thru_3_27)[41] <- "Product_SKU_w_Description"
colnames(thru_3_27)[42] <- "COVID_PRIORITY_SKU"
colnames(thru_3_27)[43] <- "PRIORITY_SKU"
colnames(thru_3_27)[44] <- "MTO_SOP"
colnames(thru_3_27)[45] <- "Macro_Platform"
colnames(thru_3_27)[46] <- "Starch_Supply_Impacted"
colnames(thru_3_27)[47] <- "Starch_Impacted"
...
thru_3_27 %>% 
  ...
  dplyr::mutate(Case_Cut_Original_Order_Qty = AS_Original_Order_Quantity - AS_Cases) -> thru_3_27
...
thru_3_27 %>% 
  ...
  dplyr::mutate(Original_Case_Fill = AS_Cases / AS_Original_Order_Quantity) -> thru_3_27


# Important index !!! ----

rbind(thru_3_20, thru_3_27) -> thru_3_27
...
thru_3_27$AS_Variable_Margine_Per_Pound[is.na(thru_3_27$AS_Variable_Margine_Per_Pound)] <- 0
thru_3_27$AS_Cases[is.na(thru_3_27$AS_Cases)] <- 0
thru_3_27$AS_Order_Quantity[is.na(thru_3_27$AS_Order_Quantity)] <- 0
thru_3_27$AS_Original_Order_Quantity[is.na(thru_3_27$AS_Original_Order_Quantity)] <- 0
thru_3_27$AS_Net_Pounds[is.na(thru_3_27$AS_Net_Pounds)] <- 0
thru_3_27$AS_Variable_Margin[is.na(thru_3_27$AS_Variable_Margin)] <- 0

thru_3_27[-1,] -> thru_3_27
save(thru_3_27, file = "thru_3_27.RData")
