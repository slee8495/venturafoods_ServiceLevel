...
# thru_2_27 %>% 
#  dplyr::filter(Ship_Year_Month != "2022 - (02) Feb" | Ship_Year_Month != "2022 - (03) Mar" ) -> thru_2_27

thru_2_27 %>% 
  dplyr::filter(Ship_Year_Month != "2022 - (02) Feb") -> thru_2_27


# Read data

thru_3_6 <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Report/Root Cause Report/2022/Mar/3.6.2022/thru 3.6.xlsx", 
...
colnames(thru_3_6)[1] <- "Super_Customer_Number"
colnames(thru_3_6)[2] <- "Super_Customer_Name"
colnames(thru_3_6)[3] <- "Mfg_Location"
colnames(thru_3_6)[4] <- "Mfg_Location_Name"
colnames(thru_3_6)[5] <- "Ship_Location"
colnames(thru_3_6)[6] <- "Ship_Location_Name"
colnames(thru_3_6)[7] <- "Product_Label"
colnames(thru_3_6)[8] <- "Product_Label_Name"
colnames(thru_3_6)[9] <- "ProductPlatformDesc"
colnames(thru_3_6)[10] <- "Line_Number"
colnames(thru_3_6)[11] <- "Line_Description"
colnames(thru_3_6)[12] <- "AS_Variable_Margine_Per_Pound"
colnames(thru_3_6)[13] <- "Pack_Size_Name"
colnames(thru_3_6)[14] <- "Product_Category_Name_105"
colnames(thru_3_6)[15] <- "Base_Product"
colnames(thru_3_6)[16] <- "Base_Product_Name_10206"
colnames(thru_3_6)[17] <- "Product_SKU"
colnames(thru_3_6)[18] <- "Product_SKU_Name_10206_GNS"
colnames(thru_3_6)[19] <- "AS_Cases"
colnames(thru_3_6)[20] <- "AS_Order_Quantity"
colnames(thru_3_6)[21] <- "AS_Original_Order_Quantity"
colnames(thru_3_6)[22] <- "AS_Net_Pounds"
colnames(thru_3_6)[23] <- "AS_Variable_Margin"
colnames(thru_3_6)[24] <- "Pack_Size"
colnames(thru_3_6)[25] <- "Shipped_Date"
colnames(thru_3_6)[26] <- "Shipped_Year"
colnames(thru_3_6)[27] <- "Shipped_Month"
colnames(thru_3_6)[28] <- "Short_Ship_Reason"
colnames(thru_3_6)[29] <- "Geo_Location"
colnames(thru_3_6)[30] <- "Channel"
colnames(thru_3_6)[31] <- "Customer"
colnames(thru_3_6)[32] <- "MFG_Site"
colnames(thru_3_6)[33] <- "Shipping_Main"
colnames(thru_3_6)[34] <- "Shipping_Location"
colnames(thru_3_6)[35] <- "Site_Line"
colnames(thru_3_6)[36] <- "Item"
colnames(thru_3_6)[37] <- "Ship_Month"
colnames(thru_3_6)[38] <- "Ship_Year_Month"
colnames(thru_3_6)[39] <- "Sysco_BAPA_SKU"
colnames(thru_3_6)[40] <- "Label_w_Desc"
colnames(thru_3_6)[41] <- "Product_SKU_w_Description"
colnames(thru_3_6)[42] <- "COVID_PRIORITY_SKU"
colnames(thru_3_6)[43] <- "PRIORITY_SKU"
colnames(thru_3_6)[44] <- "MTO_SOP"
colnames(thru_3_6)[45] <- "Macro_Platform"
colnames(thru_3_6)[46] <- "Starch_Supply_Impacted"
colnames(thru_3_6)[47] <- "Starch_Impacted"
...
thru_3_6 %>% 
  ...
  dplyr::mutate(Case_Cut_Original_Order_Qty = AS_Original_Order_Quantity - AS_Cases) -> thru_3_6
...
thru_3_6 %>% 
  ...
  dplyr::mutate(Original_Case_Fill = AS_Cases / AS_Original_Order_Quantity) -> thru_3_6


# Important index !!! ----

rbind(thru_2_27, thru_3_6) -> thru_3_6
...
thru_3_6$AS_Variable_Margine_Per_Pound[is.na(thru_3_6$AS_Variable_Margine_Per_Pound)] <- 0
thru_3_6$AS_Cases[is.na(thru_3_6$AS_Cases)] <- 0
thru_3_6$AS_Order_Quantity[is.na(thru_3_6$AS_Order_Quantity)] <- 0
thru_3_6$AS_Original_Order_Quantity[is.na(thru_3_6$AS_Original_Order_Quantity)] <- 0
thru_3_6$AS_Net_Pounds[is.na(thru_3_6$AS_Net_Pounds)] <- 0
thru_3_6$AS_Variable_Margin[is.na(thru_3_6$AS_Variable_Margin)] <- 0


save(thru_3_6, file = "thru_3_6.RData")
