...
thru_3_27 %>% 
  dplyr::filter(Ship_Year_Month != "2022 - (03) Mar") -> thru_3_27


# Read data

thru_4_3 <- read_excel("C:/Users/SLee/OneDrive - Ventura Foods/Ventura Work/SCE/Report/Root Cause Report/2022/Apr/4.3.2022/thru_4_3.xlsx", 
...
colnames(thru_4_3)[1] <- "Super_Customer_Number"
colnames(thru_4_3)[2] <- "Super_Customer_Name"
colnames(thru_4_3)[3] <- "Mfg_Location"
colnames(thru_4_3)[4] <- "Mfg_Location_Name"
colnames(thru_4_3)[5] <- "Ship_Location"
colnames(thru_4_3)[6] <- "Ship_Location_Name"
colnames(thru_4_3)[7] <- "Product_Label"
colnames(thru_4_3)[8] <- "Product_Label_Name"
colnames(thru_4_3)[9] <- "ProductPlatformDesc"
colnames(thru_4_3)[10] <- "Line_Number"
colnames(thru_4_3)[11] <- "Line_Description"
colnames(thru_4_3)[12] <- "AS_Variable_Margine_Per_Pound"
colnames(thru_4_3)[13] <- "Pack_Size_Name"
colnames(thru_4_3)[14] <- "Product_Category_Name_105"
colnames(thru_4_3)[15] <- "Base_Product"
colnames(thru_4_3)[16] <- "Base_Product_Name_10206"
colnames(thru_4_3)[17] <- "Product_SKU"
colnames(thru_4_3)[18] <- "Product_SKU_Name_10206_GNS"
colnames(thru_4_3)[19] <- "AS_Cases"
colnames(thru_4_3)[20] <- "AS_Order_Quantity"
colnames(thru_4_3)[21] <- "AS_Original_Order_Quantity"
colnames(thru_4_3)[22] <- "AS_Net_Pounds"
colnames(thru_4_3)[23] <- "AS_Variable_Margin"
colnames(thru_4_3)[24] <- "Pack_Size"
colnames(thru_4_3)[25] <- "Shipped_Date"
colnames(thru_4_3)[26] <- "Shipped_Year"
colnames(thru_4_3)[27] <- "Shipped_Month"
colnames(thru_4_3)[28] <- "Short_Ship_Reason"
colnames(thru_4_3)[29] <- "Geo_Location"
colnames(thru_4_3)[30] <- "Channel"
colnames(thru_4_3)[31] <- "Customer"
colnames(thru_4_3)[32] <- "MFG_Site"
colnames(thru_4_3)[33] <- "Shipping_Main"
colnames(thru_4_3)[34] <- "Shipping_Location"
colnames(thru_4_3)[35] <- "Site_Line"
colnames(thru_4_3)[36] <- "Item"
colnames(thru_4_3)[37] <- "Ship_Month"
colnames(thru_4_3)[38] <- "Ship_Year_Month"
colnames(thru_4_3)[39] <- "Sysco_BAPA_SKU"
colnames(thru_4_3)[40] <- "Label_w_Desc"
colnames(thru_4_3)[41] <- "Product_SKU_w_Description"
colnames(thru_4_3)[42] <- "COVID_PRIORITY_SKU"
colnames(thru_4_3)[43] <- "PRIORITY_SKU"
colnames(thru_4_3)[44] <- "MTO_SOP"
colnames(thru_4_3)[45] <- "Macro_Platform"
colnames(thru_4_3)[46] <- "Starch_Supply_Impacted"
colnames(thru_4_3)[47] <- "Starch_Impacted"
...
thru_4_3 %>% 
  ...
  dplyr::mutate(Case_Cut_Original_Order_Qty = AS_Original_Order_Quantity - AS_Cases) -> thru_4_3
...
thru_4_3 %>% 
  ...
  dplyr::mutate(Original_Case_Fill = AS_Cases / AS_Original_Order_Quantity) -> thru_4_3


# Important index !!! ----

rbind(thru_3_27, thru_4_3) -> thru_4_3
...
thru_4_3$AS_Variable_Margine_Per_Pound[is.na(thru_4_3$AS_Variable_Margine_Per_Pound)] <- 0
thru_4_3$AS_Cases[is.na(thru_4_3$AS_Cases)] <- 0
thru_4_3$AS_Order_Quantity[is.na(thru_4_3$AS_Order_Quantity)] <- 0
thru_4_3$AS_Original_Order_Quantity[is.na(thru_4_3$AS_Original_Order_Quantity)] <- 0
thru_4_3$AS_Net_Pounds[is.na(thru_4_3$AS_Net_Pounds)] <- 0
thru_4_3$AS_Variable_Margin[is.na(thru_4_3$AS_Variable_Margin)] <- 0

thru_4_3[-1,] -> thru_4_3
save(thru_4_3, file = "thru_4_3.RData")
